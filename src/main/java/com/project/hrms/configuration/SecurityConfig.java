...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                // --- THÊM DÒNG NÀY ĐỂ KÍCH HOẠT CORS CONFIG ---
                // Nó sẽ tự tìm Bean CorsConfigurationSource bên file CorsConfig của bạn
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Cho phép method OPTIONS (preflight request) đi qua mà không cần token
